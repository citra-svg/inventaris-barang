...
if (isset($_GET['confirm']) && $_GET['confirm'] == 'yes') {
    // Tambah stok barang (karena riwayat dihapus)
        ...
        <body>
            <div class='container mt-5'>
                <div class='alert alert-success'>
                    ...
                    <p>Riwayat barang keluar berhasil dihapus!</p>
                    <p>Stok <strong>'{$barang['nama_barang']}'</strong> otomatis bertambah sebanyak <strong>{$data['jumlah']}</strong>.</p>
                    <a href='index.php' class='btn btn-primary'>Kembali ke Barang Keluar</a>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-warning">
                    <i class="bi bi-info-circle"></i> Stok barang akan otomatis <strong>BERTAMBAH</strong> sebanyak <?php echo $data['jumlah']; ?>.
                </div>
